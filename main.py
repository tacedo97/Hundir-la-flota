...
tablero_contrincante = utils_Tamara.crear_tablero(10)
tablero_usuario = utils_Tamara.crear_tablero(10)
...
for eslora in esloras:
    ...
    while not barco_correcto:
        barco_contricante = utils_Tamara.crear_barco_dentro(eslora)
        barco_correcto = True
...
for eslora in esloras:
    barco_correcto = False
    while not barco_correcto:
        barco_usuario = utils_Tamara.crear_barco_dentro(eslora)
        barco_correcto = True
...
for barco_correcto_contrincante in listado_barcos_contrincante:
    tablero_contrincante = utils_Tamara.colocar_barco(barco_correcto_contrincante, tablero_contrincante)

for barco_correcto_usuario in listado_barcos_usuario:
    tablero_usuario = utils_Tamara.colocar_barco(barco_correcto_usuario, tablero_usuario)
...
tablero_contrincante_oculto = utils_Tamara.crear_tablero(10)
tablero_usuario_oculto = utils_Tamara.crear_tablero(10)
...
while disparos_faltantes_usuario > 0 and disparos_faltantes_contrincante > 0:
    ...
    tablero_contrincante = utils_Tamara.disparar(disparo_usuario, tablero_contrincante) 
    ...
    if tablero_contrincante[disparo_usuario] not in ["_", "A"]:
        ...
        tablero_contrincante_oculto = utils_Tamara.disparar(disparo_usuario, tablero_contrincante_oculto)
        ...
        while d:
            ...
            tablero_usuario_oculto = utils_Tamara.disparar(disparo_contrincante, tablero_usuario_oculto)
